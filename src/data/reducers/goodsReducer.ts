...
let initialGoodsState = {
    ...
    drySkin: [{
        ...
        description: {
            action: ['Мгновенное и продолжительное увлажнение 24 часа', 'Заживление трещин и дефектов, заметное сокращение гиперкератоза за 7 дней', 'Значительное улучшение состояния сухой и грубой кожи через две недели', 'Восстановление кожи: рост синтеза коллагена типа III', 'Насыщенная текстура, легко впитывается, не липкий, без парабенов'],
            ingredients: ['Натуральное масло ши, масло макадамии и растительный глицерин способствуют увлажнению, питанию и восстановлению кожи', 'Конский каштан и масло арники улучшают оксигенацию тканей, стимулируют микроциркуляцию, снимают воспаления', 'Ипарзин® 4А – эксклюзивный запатентованный ингредиент, поддерживает молодость кожи, способствует восстановлению, снимает воспаления'],
    ...
    wetSkin: [{
        ...
        description: {
            ...
            applying: ['Применять 1 раз в день утром. Нанести на сухую чистую кожу стопы.'],
        },
