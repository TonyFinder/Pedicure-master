...
export const introductionValues = {
    ...
    discount: {
        ...
        blocks:[
            ...
            header: 'Про слайдеры',
            lessons: [
                {id: 1, value: 'При покупке курса вы можете приобрести слайдеры ', add: 'со скидкой 25% (минимум для заказа - 5 штук)'},
                ...
                {id: 5, value: 'Будут доступны также новые форматы слайдеров! ', add: '(пока только для учеников курса)'},
        ...
        },
        {
            ...
            header: 'Про плёнки',
            lessons: [
                {id: 1, value: 'При покупке курса вы можете приобрести плёнки ', add: 'со скидкой 15% (минимум для заказа - 5 штук)'},
    ...
    buy: {
        ...
        price: '5999 рублей',
        bullet: [
                    {id: 1, value: '- Доступ 75 дней (с 29 августа по 12 ноября 2022)'},
                    {id: 2, value: '- Обратная связь'},
