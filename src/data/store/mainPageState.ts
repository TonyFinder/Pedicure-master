...
export const introductionValues = {
        ...
        blocks: [
            {
                ...
                lessons: [
                    ...
                    {id: 4, value: 'Работа фрезами', mark: 'Урок 4. '},
            ...
            },
            {
                ...
                lessons: [
                    ...
                    {id: 3, value: 'Плюс много другой полезной информации', mark: ''},
                ]
            },
            /*{
                id: 4,
    ...
    buy: [{
        ...
        link: 'https://online.pedicure-cabinet.ru',
        bullet: [
            ...
            {id: 4, value: '- Обучение на Prodamus'},
        ],
        zaglushka: [
        ...
        additions: [
            {id: 1, value: 'Доступ к МК "Плёнки"'},
            {id: 2, value: 'Доступ к МК "Слайдеры"'},
        ]
    ...
    },
        {
            ...
            link: 'https://online.pedicure-cabinet.ru/wraps',
            bullet: [
                // {id: 1, value: '- Доступ 60 дней с момента оплаты'},
                {id: 1, value: '- Доступ 100 дней вместо 60 дней'},
                {id: 2, value: '- Обратная связь'},
        ...
        },
        {
            ...
            link: 'https://online.pedicure-cabinet.ru/decals',
            bullet: [
                // {id: 1, value: '- Доступ 60 дней с момента оплаты'},
                {id: 1, value: '- Доступ 100 дней вместо 60 дней'},
                {id: 2, value: '- Обратная связь'},
